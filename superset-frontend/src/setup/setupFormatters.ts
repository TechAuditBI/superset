...
export default function setupFormatters() {
  getNumberFormatterRegistry()
    ...
    .registerValue('$,0', createD3NumberFormatter({ locale: NumberLocales.NumberLocaleDOLLAR, formatString: '$,.4f'}))
    .registerValue('$,0f', createD3NumberFormatter({ locale: NumberLocales.NumberLocaleDOLLAR, formatString: '$,.4f'}))
    .registerValue('$,.f', createD3NumberFormatter({ locale: NumberLocales.NumberLocaleDOLLAR, formatString: '$,.4f'}))
    .registerValue('$,.2f', createD3NumberFormatter({ locale: NumberLocales.NumberLocaleDOLLAR, formatString: '$,.2f'}))
    .registerValue('DURATION', createDurationFormatter())
    .registerValue('₽,.2f', createD3NumberFormatter({ locale: NumberLocales.NumberLocaleRUB, formatString: '$,.2f'}))
    .registerValue(
      'DURATION_SUB',
